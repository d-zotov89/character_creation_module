...
def attack(char_name: str, char_class: str) -> str:
    """Training the attack skill.

    Args:
        char_name (str): player name.
        char_class (str): a character class in the game.

    Returns:
        str: skill application effect - experience points.
    """
...
def choice_char_class() -> str:
    """Choose a character class in the game.
...
if __name__ == '__main__':
    def main() -> None:
        ...
        choice character class function call, training function call.
        """
        run_screensaver()
